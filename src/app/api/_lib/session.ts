...
import { Session as DbSession, profiles, type User as DbUser } from "@/db/schema";
...
async function validateRequest() {
  // Create a new request with the current headers
...
export const getCurrentUser = cache(async (): Promise<User> => {
  try {
    ...
    const dbUser = result.user as DbUser;
